...
Поделиться своим мнением на карте просто: нажмите кнопку "Поделиться мнением", затем укажите точку на карте и напишите свой комментарий во всплывающем окне.

Здесь могут быть любые ваши идеи и предложения: Что еще может появиться В Центральном лесу культуры и отдыха? Или чего здесь точно не должно быть? Каких функций или объектов вам здесь не хватает? А может быть у вас есть комментарий по конкретной зоне или площадке.
	`
	const md = new markdownit()
